...
std::vector<int>ReedsSheppStateSpace::xingshentype(double q0[3], double q1[3])
{
    ...
    std::vector<std::vector<double> > ReedsSheppStateSpace::xingshensample(double q0[], double q1[], double step_size)
{
    ReedsSheppPath path = reedsShepp(q0, q1);
